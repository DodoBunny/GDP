...
public class FoodInven : MonoBehaviour
{
            ...
            else
            {
                switch (food)
                {
                    case Define.Food.Beer:
                        ...
                        items[i] = Instantiate(Beer, ItemUI.transform);
                        break;

                    case Define.Food.Chicken:
                        inven[i] = Define.Food.Chicken;
                        items[i] = Instantiate(Chicken, ItemUI.transform);
                        break;

                    case Define.Food.Soju:
                        inven[i] = Define.Food.Soju;
                        items[i] = Instantiate(Soju, ItemUI.transform);
                        break;
                }
                break;
            }
